...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
	<?php
		...
		$sql="SELECT id FROM year ORDER BY id DESC LIMIT 1";
               ...
               <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
						...
						<form role="form" action="inserty.php" method="post">
                            <div class="row">
                                <div class="col-md-12">                                  
                                        <div class="form-group">
                                            <label>Id</label>
                                            <input class="form-control" name="id" value="<?php echo $id['id']+1;?>" readonly />
                                        </div>
								</div>
							</div>
							<div class="row">
